...
<?php
	...
	$selectquery = "SELECT * FROM user1 where id='".$userid."' order by id asc";
...
if(isset($_POST['submit']))
{
			...
			$districtnew = $_POST['districtnew'];
			$citynew= $_POST['citynew'];
			$gendernew = $_POST['gendernew'];
			$emailnew = $_POST['emailnew'];
			
			//$regno= $_REQUEST['regno'];
			//$query1 = "select id, fullName, address, district, city, gender, email from users";
			
			$update="UPDATE user1 set fullName='".$fullnamenew."', address='".$addressnew."', district='".$districtnew."',  
							city='".$citynew."', gender='".$gendernew."', email='".$emailnew."' where id='".$id."'";
			//echo $update;
			
			$updateresult = pg_exec($db_handle, $update);
			if ($updateresult) 
			{								
				echo "<br/>*** DATA UPDATED SUCSSFULLY ***<br/>";
